class Ball:
    class BallBuilder:
        ...
        def build(self):
            temp_ball = Ball(self)  # to generate commentary if needed
            if self._commentary is None:
                self._commentary = CommentaryManager.get_instance().generate_commentary(temp_ball)
            return Ball(self)

    def __init__(self, builder):
        self.ball_number = builder._ball_number
        self.bowled_by = builder._bowled_by
        self.faced_by = builder._faced_by
        self.runs_scored = builder._runs_scored
        self.wicket = builder._wicket
        self.extra_type = builder._extra_type
        self.commentary = builder._commentary
...
class Wicket:
    ...
    def __init__(self, builder):
        self.wicket_type = builder._wicket_type
        self.player_out = builder._player_out
