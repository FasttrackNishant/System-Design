package easy.notification.registeryfactory;
...
class NotificationFactory {
    ...
    public static NotificationGateway getGateway(NotificationType type) {
        ...
        if (supplier == null) {
            throw new IllegalArgumentException("Unsupported easy.notification type: " + type);
        }
        return supplier.get();
    }
}
...
class NotificationService {
    ...
    private void validate(Notification notification) {
        ...
        switch (notification.getType()) {
            ...
            default:
                throw new IllegalArgumentException("Unsupported easy.notification type");
        }
    }
}
