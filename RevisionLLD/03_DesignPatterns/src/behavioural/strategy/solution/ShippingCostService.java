...
class ShippingCostService {
    ...
    // Constructor to set initial behavioural.strategy
    public ShippingCostService(ShippingStrategy strategy) {
        this.strategy = strategy;
    }

    // Method to change behavioural.strategy at runtime
    ...
    public double calculateShippingCost(Order order) {
        if (strategy == null) {
            throw new IllegalStateException("Shipping behavioural.strategy not set.");
        }
